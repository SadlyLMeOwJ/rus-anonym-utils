...
export class ArrayUtils {
    ...
    public random<T>(inputArray: T[]): T {
        return inputArray[
            number.getRandomIntInclusive(0, inputArray.length - 1)
        ];
    }
    ...
    /**
     * @description Получает последний элемент из массива
     * @param {Array} array - Массив из которого нужно получить последний элемент
     * @returns {any} Элемент из массива
     * @example
     * // Return 2
     * array.last([1, 2]);
